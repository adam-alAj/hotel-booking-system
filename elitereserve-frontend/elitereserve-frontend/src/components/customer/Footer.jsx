  ...
  return (
      <footer className="cfooter">
        <div className="cfooter-container">
          ...
          <div className="cfooter-col cfooter-col-brand">
            <a href="/" className="cfooter-logo">
              <span className="clogo-e">elite</span>
              <span className="clogo-reserve">reserve</span>
            </a>
            <p className="cfooter-description">
            ...
            <div className="cfooter-social">
              <a href="#" className="csocial-link" aria-label="Instagram">
              ...
              <a href="#" className="csocial-link" aria-label="Twitter">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="#" className="csocial-link" aria-label="LinkedIn">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="#" className="csocial-link" aria-label="YouTube">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="cfooter-col">
            <h3 className="cfooter-col-title">Discover</h3>
            <ul className="cfooter-links">
          ...
          <div className="cfooter-col">
            <h3 className="cfooter-col-title">Company</h3>
            <ul className="cfooter-links">
          ...
          <div className="cfooter-col">
            <h3 className="cfooter-col-title">Support</h3>
            <ul className="cfooter-links">
          ...
          <div className="cfooter-col">
            <h3 className="cfooter-col-title">Connect</h3>
            <ul className="cfooter-links cfooter-contact">
              <li>
        ...
        <div className="cfooter-bottom">
          <div className="cfooter-bottom-inner">
            <div className="cfooter-copyright">
              <p>© {currentYear} EliteReserve. All rights reserved.</p>
            </div>
            <div className="cfooter-legal-links">
